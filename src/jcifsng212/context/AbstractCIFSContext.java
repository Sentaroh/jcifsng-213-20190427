...
public abstract class AbstractCIFSContext extends Thread implements CIFSContext {
     ...
     * {@inheritDoc}
     *
     * @see jcifsng212.CIFSContext#withAnonymousCredentials()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng212.CIFSContext#withDefaultCredentials()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng212.CIFSContext#withGuestCrendentials()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng212.CIFSContext#getCredentials()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng212.CIFSContext#hasDefaultCredentials()
     */
    @Override
