...
class SmbTreeHandleImpl implements SmbTreeHandleInternal {
     ...
     * {@inheritDoc}
     *
     * @see jcifsng212.SmbTreeHandle#isConnected()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng212.SmbTreeHandle#getConfig()
     */
    @Override
     ...
     */
    public <T extends CommonServerMessageBlockResponse> T send ( jcifsng212.internal.Request<T> req, RequestParam... params ) throws CIFSException {
     ...
     * {@inheritDoc}
     *
     * @see jcifsng212.SmbTreeHandle#close()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng212.SmbTreeHandle#getRemoteHostName()
     */
    @Override
     ...
     * @throws SmbException
     *
     * @see jcifsng212.SmbTreeHandle#getServerTimeZoneOffset()
     */
    @Override
     ...
     * @throws SmbException
     *
     * @see jcifsng212.SmbTreeHandle#getOEMDomainName()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng212.SmbTreeHandle#getTreeType()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng212.SmbTreeHandle#getConnectedShare()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng212.SmbTreeHandle#isSameTree(jcifsng212.SmbTreeHandle)
     */
    @Override
