...
import jcifsng212.spnego.NegTokenTarg;
import jcifsng212.spnego.SpnegoException;
import jcifsng212.spnego.SpnegoToken;
...
class SpnegoContext implements SSPContext {
     ...
     * {@inheritDoc}
     *
     * @see jcifsng212.smb.SSPContext#getNetbiosName()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng212.smb.SSPContext#getSigningKey()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng212.smb.SSPContext#verifyMIC(byte[], byte[])
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng212.smb.SSPContext#isMICAvailable()
     */
    @Override
