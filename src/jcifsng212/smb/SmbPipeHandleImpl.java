...
import jcifsng212.internal.smb1.trans.TransCallNamedPipe;
import jcifsng212.internal.smb1.trans.TransCallNamedPipeResponse;
import jcifsng212.internal.smb1.trans.TransTransactNamedPipe;
import jcifsng212.internal.smb1.trans.TransTransactNamedPipeResponse;
import jcifsng212.internal.smb1.trans.TransWaitNamedPipe;
import jcifsng212.internal.smb1.trans.TransWaitNamedPipeResponse;
import jcifsng212.internal.smb2.ioctl.Smb2IoctlRequest;
import jcifsng212.internal.smb2.ioctl.Smb2IoctlResponse;
import jcifsng212.util.ByteEncodable;
...
class SmbPipeHandleImpl implements SmbPipeHandleInternal {
     ...
     * {@inheritDoc}
     *
     * @see jcifsng212.SmbPipeHandle#unwrap(java.lang.Class)
     */
     ...
     * {@inheritDoc}
     *
     * @see jcifsng212.SmbPipeHandle#getPipe()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng212.SmbPipeHandle#isOpen()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng212.smb.SmbPipeHandleInternal#getSessionKey()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng212.SmbPipeHandle#isStale()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng212.SmbPipeHandle#getInput()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng212.SmbPipeHandle#getOutput()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng212.smb.SmbPipeHandleInternal#sendrecv(byte[], int, int, byte[], int)
     */
     ...
     * {@inheritDoc}
     *
     * @see jcifsng212.smb.SmbPipeHandleInternal#getPipeType()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng212.SmbPipeHandle#close()
     */
    @Override
